...
t268_1 <- (-0.1005 -log((met[382298,4]+0.5)/(met[382298,5]+0.5)))
t268_2 <- (-0.1005 -log((met[382299,4]+0.5)/(met[382299,5]+0.5)))
...
# SLa341 spike
SLa341_1 	<- (-0.31826 -log((met[382302,4]+0.5)/(met[382302,5]+0.5)))
SLa341_2 	<- (-0.31826 -log((met[382303,4]+0.5)/(met[382303,5]+0.5)))
SLa341_3 	<- (-0.31826 -log((met[382304,4]+0.5)/(met[382304,5]+0.5)))
sla341   	<- c(SLa341_1, SLa341_2, SLa341_3)
avgsla341	<- mean(sla341)

# SLa374 spike
SLa374_1 	<- (-0.31826 -log((met[382305,4]+0.5)/(met[382305,5]+0.5)))
SLa374_2 	<- (-0.31826 -log((met[382306,4]+0.5)/(met[382306,5]+0.5)))
SLa374_3 	<- (-0.31826 -log((met[382307,4]+0.5)/(met[382307,5]+0.5)))
