...
# t268 corresponds to spike T324 based on 99.11% meth; ln(99.11/0.89)=4.7128
t268_1 <- (4.7128 -log((met[173458,4]+0.5)/(met[173458,5]+0.5)))
t268_2 <- (4.7128 -log((met[173459,4]+0.5)/(met[173459,5]+0.5)))
...
SLa341_1 	<- (-0.31955 -log((met[173462,4]+0.5)/(met[173462,5]+0.5)))
SLa341_2 	<- (-0.31955 -log((met[173463,4]+0.5)/(met[173463,5]+0.5)))
SLa341_3 	<- (-0.31955 -log((met[173464,4]+0.5)/(met[173464,5]+0.5)))
...
SLa374_1 	<- (-0.0116 -log((met[173465,4]+0.5)/(met[173465,5]+0.5)))
SLa374_2 	<- (-0.0116 -log((met[173466,4]+0.5)/(met[173466,5]+0.5)))
SLa374_3 	<- (-0.0116 -log((met[173467,4]+0.5)/(met[173467,5]+0.5)))
